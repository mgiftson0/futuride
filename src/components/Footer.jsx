    ...
    <footer className="bg-white py-12">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-4 gap-8 mb-8">
          {/* Logo Column */}
          <div className="col-span-1 footer-logo">
          ...
          {/* Links Columns */}
          <div className="col-span-1 flex flex-col space-y-3 footer-links">
        ...
        {/* Copyright Section */}
        <div className="text-center pt-8 border-t border-gray-200 footer-copyright">
